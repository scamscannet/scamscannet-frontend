<script>
    ...
    import {domainObjectToUrl} from "$lib/converter/domain";
...
{#if loading}
    ...
    {:else if requested_page.available === 1}
        ...
        {#if requested_page.data.redirect}
                <CardView >
                    <div class="">
                        <p class="text-xl font-bold">Redirect</p>
                        <p>The requested page is redirecting all requests to {domainObjectToUrl(requested_page.data.redirect)}. You can follow the redirect by pressing the button below.</p>
                        <div class="flex justify-center w-full mt-3">
                            <Button target="_self" href="/tools/registry/{domainObjectToUrl(requested_page.data.redirect)}" >Go to {domainObjectToUrl(requested_page.data.redirect)}</Button>
                        </div>
                    </div>
                </CardView>
                    <p></p>
                    ...
                    <Accordion>
                        <AccordionItem>
                            ...
                            <div class="mb-2 text-gray-800 dark:text-gray-400 text-left">
                                <pre>
                                    <p>
                                        {pretty(requested_page.data.code.html)}
                                    </p>
                                </pre>
                            </div>
                        </AccordionItem>
